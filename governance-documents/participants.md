...
**Step 1. Go to  the [participants.md](https://github.com/finos/curref-data/blob/master/governance-documents/participants) file** and make sure you are signed into your GitHub account

**Step 2. Click on the :pen: icon at the top right of the the [participants.md](https://github.com/finos/curref-data/blob/master/governance-documents/participants) file**
...
**Step 5. Create a Pull Request** to request that the changes you made to the [participants.md](https://github.com/finos/curref-data/blob/master/governance-documents/participants) file be added to the "master" branch of the https://github.com/finos/curref-data repository
